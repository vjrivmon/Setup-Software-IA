...
| Factor | Competidor A | Competidor B | Mi Solución |
|--------|--------------|--------------|-------------|
| Precio | | | |
| Facilidad de uso | | | |
| Feature X | | | |
...
> "Imagina que tu solución existe y funciona perfectamente. 
> Describe cómo cambiaría el día a día de tu usuario típico.
> ¿Qué dejaría de hacer? ¿Qué empezaría a hacer? ¿Cómo se sentiría?"
